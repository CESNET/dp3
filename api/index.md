...
If you are wiring a new producer into a DP³ application, start with [How to add an input module](../howto/add-input/), then use this page as the endpoint reference.
...
You can see the enabled actions in [`/config/control.yml`](../configuration/control/), available are:
...
You can learn more about the actions in the [Actions](../configuration/control/#actions) section of the `Control` configuration documentation.
