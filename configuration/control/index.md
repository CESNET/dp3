...
The `Control` module serves the [`/control/...`](https://cesnet.github.io/dp3/api/#control) endpoints. This is used to execute actions that are not part of the normal operation of the application, at a time when the user decides to do so. Useful for management of the application, especially when there are changes made to the configuration.
