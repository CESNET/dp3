...
Snapshots configuration is straightforward. You can set the `creation_rate` - a cron schedule for creating new snapshots (every 30 minutes by default). See CronExpression docs for details.
