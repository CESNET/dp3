...
This guide assumes you already know the intended data model for the attribute: its entity type, attribute type, and data type. If you still need to decide that, see the [Data model](https://cesnet.github.io/dp3/data_model/index.md), [History Management](https://cesnet.github.io/dp3/history_management/index.md), and [DB entities configuration](https://cesnet.github.io/dp3/configuration/db_entities/index.md) pages first.
...
- A secondary module callback was never registered → Register the [module hook](https://cesnet.github.io/dp3/hooks/index.md)
...
- [History manager configuration](https://cesnet.github.io/dp3/configuration/history_manager/index.md)
- [Entity lifetimes](https://cesnet.github.io/dp3/configuration/lifetimes/index.md)
