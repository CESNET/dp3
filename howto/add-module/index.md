...
Use the [Module Hook Reference](../../hooks/) to pick the right callback. In your module, you can combine as many callbacks as needed for your use-case.

If the module will emit a new attribute, define that attribute first using [How to add an attribute](../add-attribute/).
...
This example is intentionally small. For more hook patterns, see [Modules](../../modules/) and [Hooks](../../hooks/).
...
If you also changed `db_entities` because the module emits a new attribute, reload the API too by following [How to add an attribute](../add-attribute/).
...
If you only change the module-specific YAML later, you may be able to reload it with the [`refresh_module_config`](../../configuration/control/#refresh_module_config) control action instead of restarting workers. New code and new hook registrations still require a worker restart.
...
- [How-to guides](../)
- [Modules](../../modules/)
- [Module Hook Reference](../../hooks/)
- [Processing core configuration](../../configuration/processing_core/)
- [Modules configuration](../../configuration/modules/)
