...
If you do not already have a local DP³ application running for development, start with [Get started with local DP³ app development](https://cesnet.github.io/dp3/howto/get-started/index.md).
...
Use the [Module Hook Reference](https://cesnet.github.io/dp3/hooks/index.md) to pick the right callback. In your module, you can combine as many callbacks as needed for your use-case.

If the module will emit a new attribute, define that attribute first using [How to add an attribute](https://cesnet.github.io/dp3/howto/add-attribute/index.md).
...
This example is intentionally small. For more hook patterns, see [Modules](https://cesnet.github.io/dp3/modules/index.md) and [Hooks](https://cesnet.github.io/dp3/hooks/index.md).
...
config/modules/normalize_hostname.yml
...
If you also changed `db_entities` because the module emits a new attribute, reload the API too by following [How to add an attribute](https://cesnet.github.io/dp3/howto/add-attribute/index.md).
...
If you only change the module-specific YAML later, you may be able to reload it with the [`refresh_module_config`](https://cesnet.github.io/dp3/configuration/control/#refresh_module_config) control action instead of restarting workers. New code and new hook registrations still require a worker restart.
...
- [Module Hook Reference](https://cesnet.github.io/dp3/hooks/index.md)
- [Processing core configuration](https://cesnet.github.io/dp3/configuration/processing_core/index.md)
- [Modules configuration](https://cesnet.github.io/dp3/configuration/modules/index.md)
