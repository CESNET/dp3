...
1. Editable installation means changes in the repository are immediately reflected in the environment.
1. Installs the repository's formatting and linting hooks for commits.
...
For documentation-specific conventions, see [Extending Documentation](https://cesnet.github.io/dp3/howto/extending/index.md).
...
- [Extending Documentation](https://cesnet.github.io/dp3/howto/extending/index.md)
